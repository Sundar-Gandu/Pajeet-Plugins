...
public class ObstacleArea
{
    ...
    public MenuEntry createMenuEntry()
    {
        ...
        {
            log.info(nextObstacle.getActions()[0] + ", " + nextObstacle.getName() + ", " + nextObstacle.getId() + ", " + "MenuAction.GAME_OBJECT_FIRST_OPTION.getId()" + ", " + getObjectParam(nextObstacle) + ", " + getObjectParam1(nextObstacle));
